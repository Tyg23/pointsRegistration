...
source, target = utils.prepare_source_and_target_rigid_3d('segmented_cloud_human.pcd')
# source, target =utils.prepare_source_and_target_nonrigid_3d('22.txt','22.txt')
